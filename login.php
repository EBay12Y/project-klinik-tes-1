...
<p><img src="images/logoKlinik2.png" width="360"></p>
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    <div class="msg"><b>LOGIN KLINIK AFRISA</b></div>
                    ...
                    <div class="row" >
                        ...
                        <div class="col-xs-5">
                            <input type="submit" name="login" value="Login" class="btn btn-block bg-blue-grey waves-effect">
                        </div>
                    </div>
    ...
    if(isset($_POST['login'])){
        ...
        if ($ketemu >=1){
            ...
            <script type="text/javascript">
                alert("Login Gagal. Username atau Password anda SALAH. Silakan Ulangi Lagi!!")
            </script>
            <?php
        }
