    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="images/logoKlinik1.png" height="25" style="float:left;margin:0 8px 4px 0;"/>KLINIK AFRISA</a>
            </div>
            
            <div>
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="#"><img src="images/profile.png" width="20" height="20" style="float:left;margin:0 2px 2px 0;"/>Profile</a>
                    </li>               
                    <li>
                        <a href="logout.php"><img src="images/logout.png" width="20" height="20" style="float:left;margin:0 2px 2px 0;"/>Sign Out</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div id="leftsidebar" class="sidebar">
            ...
            <div class="user-info bg-grey">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Klinik Afrisa</div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2022 <a href="javascript:void(0);">Klinik Afrisa</a>
                </div>
                <div class="version">
                    <b>Version: </b> 1.0
                </div>
